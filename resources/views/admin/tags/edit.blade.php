...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Sửa tag</h2>
            <p class="text-sm text-gray-500 mt-1">Chỉnh sửa tag: <strong>{{ $tag->name }}</strong></p>
        </div>
        ...
        <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
            ...
            <div class="mt-8 flex items-center gap-3">
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Cập nhật tag
                </button>
