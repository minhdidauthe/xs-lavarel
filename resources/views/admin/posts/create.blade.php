...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tạo bài viết</h2>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3"
                              ...
                              class="w-full border-gray-300 rounded-lg text-sm focus:ring-red-500 focus:border-red-500">{{ old('excerpt') }}</textarea>
                    @error('excerpt')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="scheduled" {{ old('status') === 'scheduled' ? 'selected' : '' }}>Lên lịch</option>
                    ...
                    <div x-show="open" x-collapse class="px-6 pb-6 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3"
                                      ...
                                      class="w-full border-gray-300 rounded-lg text-sm focus:ring-red-500 focus:border-red-500">{{ old('meta_description') }}</textarea>
